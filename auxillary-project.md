...
- Add user - sudo useradd -m Gbenga -p PASSWORD
- Add a group - sudo groupadd developers
- Add user to a group - sudo usermod -a -G developers Gbenga
- Verify users that are members of the group - grep developers /etc/group

  ![](images/aux-project/created-users-group.png)
